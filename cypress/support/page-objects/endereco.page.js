class EnderecoPage {
    ...
    editarEnderecoFaturamento (nome, sobrenome, empresa, pais, 
    ...
    editarEnderecoEntrega (nome, sobrenome, empresa, pais, 
        ...
        cy.get('#select2-shipping_country-container').click().type(pais)
        .get('[aria-selected="true"]').click();
